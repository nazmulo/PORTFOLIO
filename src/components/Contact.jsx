    ...
    <section id="contact" className="py-[100px] px-6 md:px-12">
      <div className="max-w-[800px] mx-auto text-center">
        <motion.div
          ...
          viewport={{ once: true }}
          className="bg-[var(--card-bg)]/40 backdrop-blur-md border border-[var(--border-color)] p-12 md:p-16 relative overflow-hidden group"
        ...
        >
          ...
          <p className="text-[var(--text-muted)] text-base md:text-[15px] leading-relaxed mb-10 max-w-[480px] mx-auto">
          ...
          <div className="flex flex-wrap justify-center gap-3.5">
            {links.map((link) => (
              <a
                ...
                className="flex items-center gap-2.5 px-5.5 py-3 border border-[var(--border-color)] text-[var(--text)] font-mono text-[12px] tracking-wider transition-all hover:border-cyan hover:text-cyan hover:shadow-[0_0_20px_rgba(0,240,255,0.15)] hover:-translate-y-0.5 clickable"
